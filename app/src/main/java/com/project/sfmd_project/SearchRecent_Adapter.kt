...
class SearchRecent_Adapter(private val profile_list : ArrayList<Profiledata2>, private val listener:OnItemClickListener):
    RecyclerView.Adapter<SearchRecent_Adapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.doctor_recent_layout, parent, false)
